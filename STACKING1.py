...
#我们这里使用6个回归算法，为了体现stacking的思想，就不加参数了
    
def calculate(getfilepath,putfirstfilepath,putsecondfilepath):
    
    rf_model = RandomForestRegressor()
    gdbc_model = GradientBoostingRegressor()
    knn_model = KNeighborsRegressor()
    xgb_model = xgb.XGBRegressor()
    svc_model = SVR()
    
#    getfilepath = 'Normalized_primitive.csv'
    
    train_x, test_x, train_y, test_y,lon_y,lat_y  = LoadData.loadData(getfilepath + '.csv')
    ...
    leval1_pd.to_csv(putfirstfilepath + 'regressor.csv', index=None)
    ...
    leval2_pd.to_csv(putsecondfilepath + 'regressor.csv', index=None)
    r2 = r2_score(test_y,df_predict)
    
    print(r2)
    
if __name__=="__main__":
    calculate(r"C:\\Users\\A\\.spyder-py3\\Form\\Normalized_primitive",r"C:\\Users\\A\\.spyder-py3\\Form\\firstlevelresult",r"C:\\Users\\A\\.spyder-py3\\Form\\secondlevelresult")
    print(111)